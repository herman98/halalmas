...
tmptlogin_required = patch_view_decorator(login_required)
tmptlogin_required_admin = patch_view_decorator(
    user_passes_test(lambda u: u.groups.filter(name='admin').exists()))


def tmptlogin_required_group(group_name):
